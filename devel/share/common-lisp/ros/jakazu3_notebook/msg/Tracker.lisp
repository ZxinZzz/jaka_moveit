...
(cl:in-package jakazu3_notebook-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <Tracker>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Tracker)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name jakazu3_notebook-msg:<Tracker> is deprecated: use jakazu3_notebook-msg:Tracker instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <Tracker>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jakazu3_notebook-msg:x-val is deprecated.  Use jakazu3_notebook-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <Tracker>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jakazu3_notebook-msg:y-val is deprecated.  Use jakazu3_notebook-msg:y instead.")
  (y m))

(cl:ensure-generic-function 'z-val :lambda-list '(m))
(cl:defmethod z-val ((m <Tracker>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jakazu3_notebook-msg:z-val is deprecated.  Use jakazu3_notebook-msg:z instead.")
  (z m))

(cl:ensure-generic-function 'error_x-val :lambda-list '(m))
(cl:defmethod error_x-val ((m <Tracker>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jakazu3_notebook-msg:error_x-val is deprecated.  Use jakazu3_notebook-msg:error_x instead.")
  (error_x m))

(cl:ensure-generic-function 'error_y-val :lambda-list '(m))
(cl:defmethod error_y-val ((m <Tracker>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jakazu3_notebook-msg:error_y-val is deprecated.  Use jakazu3_notebook-msg:error_y instead.")
  (error_y m))

(cl:ensure-generic-function 'error_z-val :lambda-list '(m))
(cl:defmethod error_z-val ((m <Tracker>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jakazu3_notebook-msg:error_z-val is deprecated.  Use jakazu3_notebook-msg:error_z instead.")
  (error_z m))

(cl:ensure-generic-function 'flag1-val :lambda-list '(m))
(cl:defmethod flag1-val ((m <Tracker>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jakazu3_notebook-msg:flag1-val is deprecated.  Use jakazu3_notebook-msg:flag1 instead.")
  (flag1 m))

(cl:ensure-generic-function 'flag2-val :lambda-list '(m))
(cl:defmethod flag2-val ((m <Tracker>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jakazu3_notebook-msg:flag2-val is deprecated.  Use jakazu3_notebook-msg:flag2 instead.")
  (flag2 m))

(cl:ensure-generic-function 'flag3-val :lambda-list '(m))
(cl:defmethod flag3-val ((m <Tracker>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jakazu3_notebook-msg:flag3-val is deprecated.  Use jakazu3_notebook-msg:flag3 instead.")
  (flag3 m))
